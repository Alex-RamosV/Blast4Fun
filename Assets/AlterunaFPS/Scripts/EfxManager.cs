...
namespace AlterunaFPS
{
	public class EfxManager : MonoBehaviour
	{
		...
		public GameObject MilkImpactPrefab;
		...
		private readonly List<EfxPoolObject> _milkImpactParticles = new();
		...
		// Read well the line 61 to change the type of ImpactType
		public void PlayImpact(Vector3 pos, Vector3 normal, Transform parent, ImpactType type = ImpactType.Milk)
		{
			switch (type)
			{
				...
				case ImpactType.Wood:
					...
					break;
				case ImpactType.Milk:
					PlayImpact(_milkImpactParticles, parent, MilkImpactPrefab, pos, normal);
					break;
